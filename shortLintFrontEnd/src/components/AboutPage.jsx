...
const AboutPage = () => {
  return (<div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        <p className="text-gray-700 text-sm  mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full ">
          ShortLink simplifies URL shortening for efficient sharing. Easily
          generate, manage, and track your shortened links. ShortLink simplifies
          URL shortening for efficient sharing. Easily generate, manage, and
          track your shortened links. ShortLink simplifies URL shortening for
          efficient sharing. Easily generate, manage, and track your shortened
          links. ShortLink simplifies URL shortening for efficient sharing.
